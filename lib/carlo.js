...
class App extends EventEmitter {
  ...
  evaluate(pageFunction, ...args) {
    debugApp('evaluate', pageFunction);
...
class Window extends EventEmitter {
  ...
  async initializeInterception_() {
    ...
    this.session_.on('Fetch.requestPaused', this.requestIntercepted_.bind(this));
    return this.session_.send('Fetch.enable', {patterns: [{urlPattern: '*'}]});
  }
